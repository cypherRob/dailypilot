...
const HabitModelSchema = CollectionSchema(
  ...
  properties: {
    ...
    r'syncStatus': PropertySchema(
      ...
      name: r'syncStatus',
      type: IsarType.byte,
      enumMap: _HabitModelsyncStatusEnumValueMap,
    ),
...
HabitModel _habitModelDeserialize(
  ...
  object.frequency =
      _HabitModelfrequencyValueEnumMap[reader.readByteOrNull(offsets[5])] ??
          HabitFrequency.daily;
  object.icon = reader.readStringOrNull(offsets[6]);
  object.id = id;
  object.syncStatus =
      _HabitModelsyncStatusValueEnumMap[reader.readByteOrNull(offsets[7])] ??
...
P _habitModelDeserializeProp<P>(
  ...
  switch (propertyId) {
    ...
    case 4:
      return (reader.readLong(offset)) as P;
    case 5:
      return (_HabitModelfrequencyValueEnumMap[reader.readByteOrNull(offset)] ??
          HabitFrequency.daily) as P;
    case 6:
      return (reader.readStringOrNull(offset)) as P;
    case 7:
      return (_HabitModelsyncStatusValueEnumMap[
...
const _HabitModelsyncStatusEnumValueMap = {
  'localOnly': 0,
  'pendingCreate': 1,
  'pendingUpdate': 2,
  'pendingDelete': 3,
...
const _HabitModelsyncStatusValueEnumMap = {
...
extension HabitModelQueryFilter
  ...
  QueryBuilder<HabitModel, HabitModel, QAfterFilterCondition> bestStreakEqualTo(
      int value) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<HabitModel, HabitModel, QAfterFilterCondition> bestStreakBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<HabitModel, HabitModel, QAfterFilterCondition> colorIsNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<HabitModel, HabitModel, QAfterFilterCondition> colorIsNotNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<HabitModel, HabitModel, QAfterFilterCondition> syncStatusEqualTo(
      SyncStatus value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
  ...
  QueryBuilder<HabitModel, HabitModel, QAfterFilterCondition> syncStatusBetween(
    SyncStatus lower,
    SyncStatus upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension HabitModelQuerySortBy
  ...
  QueryBuilder<HabitModel, HabitModel, QAfterSortBy> sortByBestStreak() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'bestStreak', Sort.asc);
    });
  }

  QueryBuilder<HabitModel, HabitModel, QAfterSortBy> sortByBestStreakDesc() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<HabitModel, HabitModel, QAfterSortBy> sortBySyncStatus() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'syncStatus', Sort.asc);
    });
  }

  QueryBuilder<HabitModel, HabitModel, QAfterSortBy> sortBySyncStatusDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension HabitModelQuerySortThenBy
  ...
  QueryBuilder<HabitModel, HabitModel, QAfterSortBy> thenByBestStreak() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'bestStreak', Sort.asc);
    });
  }

  QueryBuilder<HabitModel, HabitModel, QAfterSortBy> thenByBestStreakDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'bestStreak', Sort.desc);
    });
  }
  ...
  QueryBuilder<HabitModel, HabitModel, QAfterSortBy> thenBySyncStatus() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'syncStatus', Sort.asc);
    });
  }

  QueryBuilder<HabitModel, HabitModel, QAfterSortBy> thenBySyncStatusDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'syncStatus', Sort.desc);
    });
  }
...
extension HabitModelQueryWhereDistinct
  ...
  QueryBuilder<HabitModel, HabitModel, QDistinct> distinctByBestStreak() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<HabitModel, HabitModel, QDistinct> distinctByCompletedDates() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<HabitModel, HabitModel, QDistinct> distinctBySyncStatus() {
    return QueryBuilder.apply(this, (query) {
...
extension HabitModelQueryProperty
  ...
  QueryBuilder<HabitModel, int, QQueryOperations> bestStreakProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<HabitModel, SyncStatus, QQueryOperations> syncStatusProperty() {
    return QueryBuilder.apply(this, (query) {
