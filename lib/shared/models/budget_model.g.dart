...
const BudgetModelSchema = CollectionSchema(
  ...
  properties: {
    ...
    r'syncStatus': PropertySchema(
      ...
      name: r'syncStatus',
      type: IsarType.byte,
      enumMap: _BudgetModelsyncStatusEnumValueMap,
    ),
...
BudgetModel _budgetModelDeserialize(
  ...
  object.category =
      _BudgetModelcategoryValueEnumMap[reader.readByteOrNull(offsets[1])] ??
          ExpenseCategory.food;
  object.createdAt = reader.readDateTime(offsets[2]);
  object.id = id;
  object.syncStatus =
      _BudgetModelsyncStatusValueEnumMap[reader.readByteOrNull(offsets[3])] ??
...
P _budgetModelDeserializeProp<P>(
  ...
  switch (propertyId) {
    ...
    case 3:
      return (_BudgetModelsyncStatusValueEnumMap[
...
const _BudgetModelsyncStatusEnumValueMap = {
  'localOnly': 0,
  'pendingCreate': 1,
  'pendingUpdate': 2,
  'pendingDelete': 3,
...
const _BudgetModelsyncStatusValueEnumMap = {
...
extension BudgetModelQueryProperty
  ...
  QueryBuilder<BudgetModel, ExpenseCategory, QQueryOperations>
      categoryProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<BudgetModel, SyncStatus, QQueryOperations> syncStatusProperty() {
    return QueryBuilder.apply(this, (query) {
