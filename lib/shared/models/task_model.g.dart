...
const TaskModelSchema = CollectionSchema(
  ...
  properties: {
    ...
    r'repeatType': PropertySchema(
      ...
      name: r'repeatType',
      type: IsarType.byte,
      enumMap: _TaskModelrepeatTypeEnumValueMap,
    ),
    r'syncStatus': PropertySchema(
      id: 7,
      name: r'syncStatus',
      type: IsarType.byte,
      enumMap: _TaskModelsyncStatusEnumValueMap,
    ),
...
void _taskModelSerialize(
  ...
  writer.writeByte(offsets[6], object.repeatType.index);
...
TaskModel _taskModelDeserialize(
  ...
  object.repeatType =
      _TaskModelrepeatTypeValueEnumMap[reader.readByteOrNull(offsets[6])] ??
          RepeatType.none;
  object.syncStatus =
      _TaskModelsyncStatusValueEnumMap[reader.readByteOrNull(offsets[7])] ??
...
P _taskModelDeserializeProp<P>(
  ...
  switch (propertyId) {
    ...
    case 5:
      return (reader.readDateTimeOrNull(offset)) as P;
    case 6:
      return (_TaskModelrepeatTypeValueEnumMap[reader.readByteOrNull(offset)] ??
          RepeatType.none) as P;
    case 7:
      return (_TaskModelsyncStatusValueEnumMap[reader.readByteOrNull(offset)] ??
...
const _TaskModelrepeatTypeEnumValueMap = {
  'none': 0,
  'daily': 1,
  'weekly': 2,
  'monthly': 3,
};
const _TaskModelrepeatTypeValueEnumMap = {
  0: RepeatType.none,
  1: RepeatType.daily,
  2: RepeatType.weekly,
  3: RepeatType.monthly,
};
const _TaskModelsyncStatusEnumValueMap = {
  'localOnly': 0,
  'pendingCreate': 1,
  'pendingUpdate': 2,
  'pendingDelete': 3,
...
const _TaskModelsyncStatusValueEnumMap = {
  0: SyncStatus.localOnly,
  1: SyncStatus.pendingCreate,
  2: SyncStatus.pendingUpdate,
  3: SyncStatus.pendingDelete,
  4: SyncStatus.synced,
  5: SyncStatus.conflict,
  6: SyncStatus.failed,
};
...
extension TaskModelQueryFilter
  ...
  QueryBuilder<TaskModel, TaskModel, QAfterFilterCondition> repeatTypeEqualTo(
      RepeatType value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
  ...
  QueryBuilder<TaskModel, TaskModel, QAfterFilterCondition> repeatTypeLessThan(
    RepeatType value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<TaskModel, TaskModel, QAfterFilterCondition> repeatTypeBetween(
    RepeatType lower,
    RepeatType upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<TaskModel, TaskModel, QAfterFilterCondition> syncStatusEqualTo(
      SyncStatus value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
  ...
  QueryBuilder<TaskModel, TaskModel, QAfterFilterCondition> syncStatusLessThan(
    SyncStatus value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<TaskModel, TaskModel, QAfterFilterCondition> syncStatusBetween(
    SyncStatus lower,
    SyncStatus upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension TaskModelQuerySortBy on QueryBuilder<TaskModel, TaskModel, QSortBy> {
  ...
  QueryBuilder<TaskModel, TaskModel, QAfterSortBy> sortByRepeatType() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'repeatType', Sort.asc);
    });
  }

  QueryBuilder<TaskModel, TaskModel, QAfterSortBy> sortByRepeatTypeDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'repeatType', Sort.desc);
    });
  }

  QueryBuilder<TaskModel, TaskModel, QAfterSortBy> sortBySyncStatus() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'syncStatus', Sort.asc);
    });
  }

  QueryBuilder<TaskModel, TaskModel, QAfterSortBy> sortBySyncStatusDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension TaskModelQuerySortThenBy
  ...
  QueryBuilder<TaskModel, TaskModel, QAfterSortBy> thenByRepeatType() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'repeatType', Sort.asc);
    });
  }

  QueryBuilder<TaskModel, TaskModel, QAfterSortBy> thenByRepeatTypeDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'repeatType', Sort.desc);
    });
  }

  QueryBuilder<TaskModel, TaskModel, QAfterSortBy> thenBySyncStatus() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'syncStatus', Sort.asc);
    });
  }

  QueryBuilder<TaskModel, TaskModel, QAfterSortBy> thenBySyncStatusDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'syncStatus', Sort.desc);
    });
  }
...
extension TaskModelQueryWhereDistinct
  ...
  QueryBuilder<TaskModel, TaskModel, QDistinct> distinctByRepeatType() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'repeatType');
    });
  }

  QueryBuilder<TaskModel, TaskModel, QDistinct> distinctBySyncStatus() {
    return QueryBuilder.apply(this, (query) {
...
extension TaskModelQueryProperty
  ...
  QueryBuilder<TaskModel, RepeatType, QQueryOperations> repeatTypeProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'repeatType');
    });
  }

  QueryBuilder<TaskModel, SyncStatus, QQueryOperations> syncStatusProperty() {
    return QueryBuilder.apply(this, (query) {
