...
const GoalModelSchema = CollectionSchema(
  ...
  properties: {
    ...
    r'syncStatus': PropertySchema(
      ...
      name: r'syncStatus',
      type: IsarType.byte,
      enumMap: _GoalModelsyncStatusEnumValueMap,
    ),
...
GoalModel _goalModelDeserialize(
  ...
  object.syncStatus =
      _GoalModelsyncStatusValueEnumMap[reader.readByteOrNull(offsets[4])] ??
          SyncStatus.localOnly;
  object.targetAmount = reader.readDouble(offsets[5]);
  object.targetDate = reader.readDateTime(offsets[6]);
...
P _goalModelDeserializeProp<P>(
  ...
  switch (propertyId) {
    ...
    case 3:
      return (reader.readString(offset)) as P;
    case 4:
      return (_GoalModelsyncStatusValueEnumMap[reader.readByteOrNull(offset)] ??
...
const _GoalModelsyncStatusEnumValueMap = {
  'localOnly': 0,
  'pendingCreate': 1,
  'pendingUpdate': 2,
  'pendingDelete': 3,
...
const _GoalModelsyncStatusValueEnumMap = {
...
extension GoalModelQueryProperty
  ...
  QueryBuilder<GoalModel, SyncStatus, QQueryOperations> syncStatusProperty() {
    return QueryBuilder.apply(this, (query) {
